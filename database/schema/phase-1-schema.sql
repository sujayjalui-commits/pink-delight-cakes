...
CREATE TABLE IF NOT EXISTS business_settings (
  ...
  featured_spotlight_title TEXT,
  featured_spotlight_description TEXT,
  featured_spotlight_image_url TEXT,
  featured_spotlight_source_url TEXT,
  hero_product_slug_1 TEXT,
  hero_product_slug_2 TEXT,
  hero_product_slug_3 TEXT,
  hero_product_slug_4 TEXT,
  address_line_1 TEXT,
  address_line_2 TEXT,
  state_region TEXT,
  postal_code TEXT,
